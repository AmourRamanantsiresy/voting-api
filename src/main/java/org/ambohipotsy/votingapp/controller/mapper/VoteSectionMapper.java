...
public class VoteSectionMapper {
  ...
  public org.ambohipotsy.votingapp.repository.entity.VoteSection toDomain(VoteSection vote) {
    org.ambohipotsy.votingapp.repository.entity.VoteSection mapped =
        new org.ambohipotsy.votingapp.repository.entity.VoteSection();
    if (vote.getId() != null) {
      Optional<org.ambohipotsy.votingapp.repository.entity.VoteSection> currentVoteSection =
          voteRepository.findById(vote.getId());
      mapped =
          currentVoteSection.orElseThrow(
              () -> new NotFoundException("Vote with id=" + vote.getId() + " not found."));
    }
