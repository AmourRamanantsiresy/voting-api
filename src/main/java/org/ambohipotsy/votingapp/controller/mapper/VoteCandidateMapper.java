...
public class VoteCandidateMapper {
  ...
  public org.ambohipotsy.votingapp.repository.entity.VoteCandidate toDomain(
      String voteSectionId, VoteCandidate candidate) {
            ...
            .orElseThrow(
                () ->
                    new NotFoundException(
                        "Vote section with id=" + candidate.getId() + " not found."));
